...
class TenantDatabase {
    ...
    private function beforeThreeSixty($clientId = null) {
        ...
        MultitenancySchema::create('shareholders', function (Blueprint $table) {
            ...
            $table->string('state_one')->nullable();
            $table->string('zip_one')->nullable();
            $table->string('deliv_one')->nullable();
            $table->string('country_two')->nullable();
            $table->string('address_two')->nullable();
            $table->string('city_two')->nullable();
            $table->string('state_two')->nullable();
            $table->string('zip_two')->nullable();
            $table->string('deliv_two')->nullable();
            $table->string('primary_tin_name')->nullable();
            $table->string('primary_tin_radio')->nullable();
            $table->string('second_tin_name')->nullable();
            $table->string('second_tin_radio')->nullable();
            $table->string('benefical_owner')->nullable();
            ...
            $table->string('use_address_two_for_checks')->nullable();
