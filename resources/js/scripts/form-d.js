...
$('#add-related-person').on('click', function () {
    ...
    let tableTwoForm = '<form id="table-related-person">\n' +
        ...
        '         <input id="executive" type="checkbox" name="executive" value="1"/>\n' +
        '          <label for="executive" class="FormText">Executive Officer</label>\n' +
        '    </div><br>\n' +
        '    <div class="checkbox" style="margin-bottom: 5px;">\n' +
        '         <input id="director" type="checkbox" name="director" value="1"/>\n' +
        '          <label for="director" class="FormText">Director</label>\n' +
        '    </div><br>\n' +
        '    <div class="checkbox" style="margin-bottom: 5px;">\n' +
        '         <input id="promoter" type="checkbox" name="promoter" value="1"/>\n' +
        '          <label for="promoter" class="FormText">Promoter</label>\n' +
        '    </div><br>\n' +
        '    <div class="form-group">\n' +
...
$('#add-recipient').on('click', function () {
    ...
    let tableTwoForm = '<form id="table-recipient">\n' +
        ...
        '         <input id="none" type="checkbox" name="none" value="☐"/>\n' +
        '          <label for="none" class="FormText">None</label>\n' +
        '    </div>\n' +
        '    <div class="form-group">\n' +
        '        <input style="color: #000" class="form-control" name="broker-dealer" type="text" placeholder="(Associated) Broker or Dealer"/>\n' +
        '    </div>\n' +
        '    <div class="checkbox" style="margin-bottom: 10px;">\n' +
        '         <input id="none-broker" type="checkbox" name="none-broker" value="☐"/>\n' +
        '          <label for="none-broker" class="FormText">None</label>\n' +
        '    </div>\n' +
        '    <div class="form-group">\n' +
        ...
        '    </div>\n' +
        '    <div class="checkbox" style="margin-bottom: 10px;">\n' +
        '         <input id="none-crd" type="checkbox" name="none-crd" value="☐"/>\n' +
        '          <label for="none-crd" class="FormText">None</label>\n' +
        '    </div>\n' +
        '    <div class="form-group">\n' +
        '        <input style="color: #000" class="form-control" name="address1" type="text" placeholder="Street Address 1"/>\n' +
        '    </div>\n' +
        ...
        '    <div class="checkbox">\n' +
        '         <input id="all-states" type="checkbox" name="all-states" value="☐"/>\n' +
        '          <label for="all-states" class="FormText">All States</label>\n' +
        '    </div>\n' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="al" type="checkbox" name="AL" value="☐"/>' +
        '          <label for="al" class="FormText">AL</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ak" type="checkbox" name="AK" value="☐"/>' +
        '          <label for="ak" class="FormText">AK</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="az" type="checkbox" name="AZ" value="☐"/>' +
        '          <label for="az" class="FormText">AZ</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ar" type="checkbox" name="AR" value="☐"/>' +
        '          <label for="ar" class="FormText">AR</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ca" type="checkbox" name="CA" value="☐"/>' +
        '          <label for="ca" class="FormText">CA</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="co" type="checkbox" name="CO" value="☐"/>' +
        '          <label for="co" class="FormText">CO</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ct" type="checkbox" name="CT" value="☐"/>' +
        '          <label for="ct" class="FormText">CT</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="de" type="checkbox" name="DE" value="☐"/>' +
        '          <label for="de" class="FormText">DE</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="dc" type="checkbox" name="DC" value="☐"/>' +
        '          <label for="dc" class="FormText">DC</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="fl" type="checkbox" name="FL" value="☐"/>' +
        '          <label for="fl" class="FormText">FL</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ga" type="checkbox" name="GA" value="☐"/>' +
        '          <label for="ga" class="FormText">GA</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="hi" type="checkbox" name="HI" value="☐"/>' +
        '          <label for="hi" class="FormText">HI</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="pr" type="checkbox" name="PR" value="☐"/>' +
        '          <label for="pr" class="FormText">PR</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="id" type="checkbox" name="ID" value="☐"/>' +
        '          <label for="id" class="FormText">ID</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="il" type="checkbox" name="IL" value="☐"/>' +
        '          <label for="il" class="FormText">IL</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="in" type="checkbox" name="IN" value="☐"/>' +
        '          <label for="in" class="FormText">IN</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ia" type="checkbox" name="IA" value="☐"/>' +
        '          <label for="ia" class="FormText">IA</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ks" type="checkbox" name="KS" value="☐"/>' +
        '          <label for="ks" class="FormText">KS</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ky" type="checkbox" name="KY" value="☐"/>' +
        '          <label for="ky" class="FormText">KY</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="la" type="checkbox" name="LA" value="☐"/>' +
        '          <label for="la" class="FormText">LA</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="me" type="checkbox" name="ME" value="☐"/>' +
        '          <label for="me" class="FormText">ME</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="md" type="checkbox" name="MD" value="☐"/>' +
        '          <label for="md" class="FormText">MD</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ma" type="checkbox" name="MA" value="☐"/>' +
        '          <label for="ma" class="FormText">MA</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="mi" type="checkbox" name="MI" value="☐"/>' +
        '          <label for="mi" class="FormText">MI</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="mn" type="checkbox" name="MN" value="☐"/>' +
        '          <label for="mn" class="FormText">MN</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ms" type="checkbox" name="MS" value="☐"/>' +
        '          <label for="ms" class="FormText">MS</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="mo" type="checkbox" name="MO" value="☐"/>' +
        '          <label for="mo" class="FormText">MO</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="mt" type="checkbox" name="MT" value="☐"/>' +
        '          <label for="mt" class="FormText">MT</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ne" type="checkbox" name="NE" value="☐"/>' +
        '          <label for="ne" class="FormText">NE</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="nv" type="checkbox" name="NV" value="☐"/>' +
        '          <label for="nv" class="FormText">NV</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="nh" type="checkbox" name="NH" value="☐"/>' +
        '          <label for="nh" class="FormText">NH</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="nj" type="checkbox" name="NJ" value="☐"/>' +
        '          <label for="nj" class="FormText">NJ</label>' +
        '    </div>' +

        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="nm" type="checkbox" name="NM" value="☐"/>' +
        '          <label for="nm" class="FormText">NM</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ny" type="checkbox" name="NY" value="☐"/>' +
        '          <label for="ny" class="FormText">NY</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="nc" type="checkbox" name="NC" value="☐"/>' +
        '          <label for="nc" class="FormText">NC</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="nd" type="checkbox" name="ND" value="☐"/>' +
        '          <label for="nd" class="FormText">ND</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="oh" type="checkbox" name="OH" value="☐"/>' +
        '          <label for="oh" class="FormText">OH</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ok" type="checkbox" name="OK" value="☐"/>' +
        '          <label for="ok" class="FormText">OK</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="or" type="checkbox" name="OR" value="☐"/>' +
        '          <label for="or" class="FormText">OR</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="pa" type="checkbox" name="PA" value="☐"/>' +
        '          <label for="pa" class="FormText">PA</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ri" type="checkbox" name="RI" value="☐"/>' +
        '          <label for="ri" class="FormText">RI</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="sc" type="checkbox" name="SC" value="☐"/>' +
        '          <label for="sc" class="FormText">SC</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="sd" type="checkbox" name="SD" value="☐"/>' +
        '          <label for="sd" class="FormText">SD</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="tn" type="checkbox" name="TN" value="☐"/>' +
        '          <label for="tn" class="FormText">TN</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="tx" type="checkbox" name="TX" value="☐"/>' +
        '          <label for="tx" class="FormText">TX</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="ut" type="checkbox" name="UT" value="☐"/>' +
        '          <label for="ut" class="FormText">UT</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="vt" type="checkbox" name="VT" value="☐"/>' +
        '          <label for="vt" class="FormText">VT</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="va" type="checkbox" name="VA" value="☐"/>' +
        '          <label for="va" class="FormText">VA</label>' +
        '    </div>' +
        '</div>' +
        '<div class="row">' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="wa" type="checkbox" name="WA" value="☐"/>' +
        '          <label for="wa" class="FormText">WA</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="wv" type="checkbox" name="WV" value="☐"/>' +
        '          <label for="wv" class="FormText">WV</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="wi" type="checkbox" name="WI" value="☐"/>' +
        '          <label for="wi" class="FormText">WI</label>' +
        '    </div>' +
        '    <div class="checkbox" style="margin-left: 15px;">' +
        '         <input id="wy" type="checkbox" name="WY" value="☐"/>' +
        '          <label for="wy" class="FormText">WY</label>' +
        '    </div>' +
        '</div>' +
        '<br>\n' +
        '    <div class="checkbox" margin-bottom:10px;">' +
        '         <input id="foreign" type="checkbox" name="foreign" value="☐"/>' +
        '          <label for="foreign" class="FormText">Foreign/non-US</label>' +
        '    </div>' +
        '<br>\n' ;
...
function generateTableIRow(data) {
    ...
    let issuer = '<tr class="signature">\n' +
        ...
        '            <td class="delete-cursor" ><a style="cursor: pointer;" class="delete-issuer-person"><i class="bx bx-x" aria-hidden="true"></i></a>\n</td>' +
        '</tr>';
