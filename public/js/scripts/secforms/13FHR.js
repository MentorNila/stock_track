...
function generateTableRPRow(data) {
        ...
        let Manager = ' ' +
            ...
            '<td><a style="cursor: pointer;" class="delete-reporting-manager"><i class="fa fa-times" aria-hidden="true"></i></a>\n</td>' +
            '</tr>\n';
...
function generateTableRow(data) {
        ...
        let List = '' +
            ...
            '<td><a style="cursor: pointer;" class="delete-listed-managers"><i class="fa fa-times" aria-hidden="true"></i></a>\n</td>' +
            '</tr>\n';
...
function generateTableRRow(data) {
    ...
    let TableInfo = ' ' +
        ...
        '<td><a style="cursor: pointer;" style="color:blue;"  class="delete-table"><i class="fa fa-times" aria-hidden="true"></i></a>\n</td>' +
        '</tr>\n';
