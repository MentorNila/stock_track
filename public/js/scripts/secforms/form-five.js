...
$('#add-table-one-item').on('click', function () {
    ...
    let tableOneForm ='<form id="table-one">\n' +
        '    <label>Table I - Non-Derivative Securities Acquired, Disposed of, or Beneficially Owned</label>\n' +
        ...
        '    </div>\n' +
        '    <div class="form-group">\n' +
        '        <input style="color: #000" class="form-control" name="code" type="text" placeholder="3. Transaction Code (Instr. 8)">\n' +
        '        </br>'+ select('code-num') +'\n' +
        '    </div>\n' +
        '    <div class="form-group">\n' +
        ...
        '    </div>\n' +
        '    <div class="form-group">\n' +
        '        <input style="color: #000" class="form-control" name="secben" type="text" placeholder="5. Amount of Securities Beneficially Owned at end of Issuer\'s Fiscal Year (Instr. 3 and 4)">\n' +
...
function generateTableOneRow(data) {
    ...
    let row = '<tr class="non-derivative">\n' +
        ...
        '    <td align="center"><span class="FormText"></span><span class="FormData filing-data priceone"  data-name="price">'+ data ['price'] +'</span><span class="FootnoteData"><sup class="filing-data" data-name="price-num">' + data['price-num'] + '</sup></span></td>\n' +
        ...
        '    <td align="center"><span class="FormData"><span class="FormData filing-data" data-name="owner">'+ data ['owner'] +'</span><span class="FootnoteData"><sup class="filing-data" data-name="owner-num">' + data['owner-num'] + '</sup></span></td>\n' +
        ...
        '    <td><a style="cursor: pointer" class="delete-row"><i class="fa fa-times" aria-hidden="true"></i></a></td>\n' +
        '    </tr>';
...
$('#add-table-two-item').on('click', function () {
    ...
    let tableTwoForm ='<form id="table-two">\n' +
        ...
        '    </div>\n' +
        '    <div class="form-group">\n' +
        '        <input style="color: #000" class="form-control" name="code" type="text" placeholder="4. Transaction Code (Instr. 8)">\n' +
        '        </br>'+ select('code-num') +'\n' +
        '    </div>\n' +
        '    <div class="form-group">\n' +
...
function generateTableTwoRow(data) {
    ...
    let row = '<tr class="derivative">\n' +
        ...
        '        <td align="center"><span class="SmallFormText" style="color:black"></span><span class="SmallFormData filing-data" data-name="conversion">' + data['conversion'] + '</span><span class="FootnoteData"><sup class="filing-data" data-name="conversion-num">' + data['conversion-num'] + '</sup></span></td>\n' +
        ...
        '        <td align="center"><span class="SmallFormData filing-data" data-name="exercisable-date">' + data['exercisable-date'] + '</span><span class="FootnoteData"><sup class="filing-data" data-name="exercisable-date-num">' + data['exercisable-date-num'] + '</sup></span>\n' +
        ...
        '        <td align="center"><span class="FormData filing-data" data-name="shares">' + data['shares'] + '</span><span class="FootnoteData"><sup class="filing-data" data-name="shares-num">' + data['shares-num'] + '</sup></span></td>\n' +
        '        <td align="center"><span class="SmallFormText"></span><span class="SmallFormData filing-data" data-name="derivative">' + data['derivative'] + '</span><span class="FootnoteData"><sup class="filing-data" data-name="derivative-num">' + data['derivative-num'] + '</sup></span></td>\n' +
        ...
        '        <td align="center"><span class="SmallFormData"><span class="SmallFormData filing-data" data-name="ownership">' + data['ownership'] + '</span><span class="FootnoteData"><sup class="filing-data" data-name="ownership-num">' + data['ownership-num'] + '</sup></span>\n' +
        '        <td align="left"><span class="SmallFormData filing-data" data-name="nature">' + data['nature'] + '</span><span class="FootnoteData"><sup class="filing-data" data-name="nature-num">' + data['nature-num'] + '</sup></span></td>\n' +
        '        <td><a style="cursor: pointer" class="delete-row"><i class="fa fa-times" aria-hidden="true"></i></a></td>\n' +
        '    </tr>';
...
$('body').on('click', '#add-exp-rsp', function () {
    let row = '<tr><td class="FootnoteData"><span class="editable"><span class="attributes"></span><span class="text filing-data" id="footnote" data-name="footnote"></span><span class="input"><input class="responseInput" size="200" type="text" placeholder="" value='+index+'.></span></span></td>\n' +
        '<td><a style="cursor: pointer" class="delete-row"><i class="fa fa-times" aria-hidden="true"></i></a></td></tr>';
