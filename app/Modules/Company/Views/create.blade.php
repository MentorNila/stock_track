        ...
        <div class="card-content">
            <div class="card-body">
                ...
                <form action="{{ route("admin.companies.store") }}" method="POST" enctype="multipart/form-data">
                    @csrf<ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            ...
                            <div class="table-responsive">
                                <div id="inputFormRow">
                                    <div class="input-group mb-3">
                                        <textarea type="text" name="notes[]" class="form-control m-input" placeholder="Enter Note">
                                        </textarea>
                                ...
                                <div id="newRow"></div>
                                <button id="addRow" type="button" class="btn btn-info">Add Note</button>
...
<script type="text/javascript">
    ...
    $("#addRow").click(function() {
        ...
        html += '<textarea type="text" name="notes[]" class="form-control m-input" placeholder="Enter Note" autocomplete="off"></textarea>';
