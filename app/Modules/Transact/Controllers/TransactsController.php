...
class TransactsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('Transact::index', compact('shareholders'))->with(['shareholders' => $shareholders]);
    }

    public function pending_transact(Request $request)
    {
        $shareholders = Shareholder::get();
        return view('Transact::pending', compact('shareholders'))->with(['shareholders' => $shareholders]);
    }
