            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                        <form action="{{ route("admin.users.update", [$user->id]) }}" id="userForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('companies') ? 'has-error' : '' }}">
                                        ...
                                        <select name="companies[]" id="companies" class="select2 select2-container select2-container--default" multiple="multiple" required>
                                            @foreach($companies as $id => $company)
                                                <option value="{{ $company->id }}" {{ (in_array($company->id, old('users', [])) || isset($user) && $user->companies->contains($company->id)) ? 'selected' : '' }}>{{ $company->name }}</option>
                                            @endforeach
                                        </select>
